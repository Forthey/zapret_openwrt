...
if [ $ZAPRET_CFG_NAME = "zapret" ]; then
	ZAP_REL_URL="https://raw.githubusercontent.com/Forthey/zapret_openwrt/gh-pages/releases/releases_zap1_$ZAP_CPU_ARCH.json"
fi
if [ $ZAPRET_CFG_NAME = "zapret2" ]; then
	ZAP_REL_URL="https://raw.githubusercontent.com/Forthey/zapret_openwrt/gh-pages/releases/releases_zap2_$ZAP_CPU_ARCH.json"
fi
CURL_TIMEOUT=5
